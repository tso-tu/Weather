...
class ChartMarkerView(context: Context) : MarkerView(context, R.layout.marker_view) {
    ...
    private val feelsLikeView: TextView = findViewById(R.id.feels_like)
    ...
    override fun refreshContent(e: Entry?, highlight: Highlight?) {
        ...
        feelsLikeView.text = "${day.hoursList[e!!.x.toInt()].feelsLike}°"
        val weatherImg = when (day.hoursList[e.x.toInt()].weather) {
